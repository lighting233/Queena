    ...
    <View className={`${prefixClass}__content`}>
      <View className={`${prefixClass}__header`}>
        <View className={`${prefixClass}__att`}>
          ...
          <Input value={name} onInput={handleNameChange} placeholder='请输入' placeholderClass="place-holder"/>
        </View>
        <View className={`${prefixClass}__att`}>
        ...
        <View className={`${prefixClass}__att`}>
          ...
          <Input value={tag} onInput={handleTagChange} placeholder='请输入' placeholderClass="place-holder"/>
        </View>
        <View className={`${prefixClass}__att`}>
          <View className={`${prefixClass}__att-name`}>描述：</View>
          <Textarea className="coupons-add__att-text" value={text} onInput={handleTextChange} placeholder='请输入' placeholderClass="place-holder"/>
        </View>
      </View>
      <View className={`${prefixClass}__count-wrapper`}>
        <View className={`${prefixClass}__count`}>
          <Input type='number' value={count} onInput={handleCountChange} placeholder='数量' className='shuliang' style={{color: 'white', fontSize: 18}}  placeholderClass="white-place-holder"/>
        </View>
      </View>
    </View>
    <View className={`${prefixClass}__footer`}>
      <Button className={`${prefixClass}__footer-btn`} onClick={handleCancel}>取消</Button>
      <Button style={{ marginLeft: '12px', backgroundColor: '#cf6970' }} className={`${prefixClass}__footer-btn`} type='primary' onClick={handleConfirm}>确定</Button>
    </View>
  </View>
};
